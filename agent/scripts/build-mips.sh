...
out=${1:-"$root/artifacts/agent-2.1.2"}
mkdir -p "$out"
...
(cd "$out" && sha256sum niseva-agent niseva-agent_2.1.2-1_mips_24kc.ipk > SHA256SUMS)
echo "Built $out/niseva-agent_2.1.2-1_mips_24kc.ipk"
