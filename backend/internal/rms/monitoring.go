...
var monitoringMetricCatalog = []catalogMetric{
	...
	{ID: "ipsec.state", Category: "VPN and failover", Description: "Per-tunnel IPsec state", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "state", Path: "/state", Label: "Tunnel state", Kind: "state"}},
	{ID: "ipsec.ike_state", Category: "VPN and failover", Description: "Per-tunnel IKE security association state", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "ike_state", Path: "/ike_state", Label: "IKE state", Kind: "state"}},
	{ID: "ipsec.child_state", Category: "VPN and failover", Description: "Per-tunnel CHILD security association state", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "child_state", Path: "/child_state", Label: "CHILD state", Kind: "state"}},
	{ID: "ipsec.ike_version", Category: "VPN and failover", Description: "IKE protocol version used by the tunnel", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "ike_version", Path: "/ike_version", Label: "IKE version", Kind: "text"}},
	{ID: "ipsec.bytes_in", Category: "VPN and failover", Description: "Per-tunnel received bytes", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "bytes_in", Path: "/bytes_in", Label: "Tunnel received", Unit: "B", Kind: "counter"}},
	{ID: "ipsec.bytes_out", Category: "VPN and failover", Description: "Per-tunnel transmitted bytes", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "bytes_out", Path: "/bytes_out", Label: "Tunnel sent", Unit: "B", Kind: "counter"}},
	{ID: "ipsec.packets_in", Category: "VPN and failover", Description: "Per-tunnel received packets", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "packets_in", Path: "/packets_in", Label: "Tunnel packets received", Kind: "counter"}},
	{ID: "ipsec.packets_out", Category: "VPN and failover", Description: "Per-tunnel transmitted packets", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "packets_out", Path: "/packets_out", Label: "Tunnel packets sent", Kind: "counter"}},
	{ID: "ipsec.established", Category: "VPN and failover", Description: "Seconds since the IKE security association was established", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "established_seconds", Path: "/established_seconds", Label: "IKE established", Unit: "s", Kind: "gauge"}},
	{ID: "ipsec.installed", Category: "VPN and failover", Description: "Seconds since the CHILD security association was installed", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "installed_seconds", Path: "/installed_seconds", Label: "CHILD installed", Unit: "s", Kind: "gauge"}},
	{ID: "ipsec.rekey", Category: "VPN and failover", Description: "Seconds until the next IPsec rekey", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "rekey_seconds", Path: "/rekey_seconds", Label: "Rekey in", Unit: "s", Kind: "gauge"}},
	{ID: "ipsec.reauth", Category: "VPN and failover", Description: "Seconds until the next IKE reauthentication", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "reauth_seconds", Path: "/reauth_seconds", Label: "Reauth in", Unit: "s", Kind: "gauge"}},
	{ID: "ipsec.lifetime", Category: "VPN and failover", Description: "Seconds until the IPsec lifetime expires", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "lifetime_seconds", Path: "/lifetime_seconds", Label: "Lifetime remaining", Unit: "s", Kind: "gauge"}},
	{ID: "ipsec.last_use_in", Category: "VPN and failover", Description: "Seconds since inbound IPsec traffic last used the tunnel", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "use_in_seconds", Path: "/use_in_seconds", Label: "Last inbound use", Unit: "s", Kind: "gauge"}},
	{ID: "ipsec.last_use_out", Category: "VPN and failover", Description: "Seconds since outbound IPsec traffic last used the tunnel", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "use_out_seconds", Path: "/use_out_seconds", Label: "Last outbound use", Unit: "s", Kind: "gauge"}},
	{ID: "ipsec.local_host", Category: "VPN and failover", Description: "Local IPsec endpoint", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "local_host", Path: "/local_host", Label: "Local endpoint", Kind: "text"}},
	{ID: "ipsec.remote_host", Category: "VPN and failover", Description: "Remote IPsec endpoint", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "remote_host", Path: "/remote_host", Label: "Remote endpoint", Kind: "text"}},
	{ID: "ipsec.local_id", Category: "VPN and failover", Description: "Local IKE identity", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "local_id", Path: "/local_id", Label: "Local IKE identity", Kind: "text"}},
	{ID: "ipsec.remote_id", Category: "VPN and failover", Description: "Remote IKE identity", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "remote_id", Path: "/remote_id", Label: "Remote IKE identity", Kind: "text"}},
	{ID: "ipsec.mode", Category: "VPN and failover", Description: "IPsec child security association mode", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "mode", Path: "/mode", Label: "IPsec mode", Kind: "text"}},
	{ID: "ipsec.protocol", Category: "VPN and failover", Description: "IPsec child security association protocol", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "protocol", Path: "/protocol", Label: "IPsec protocol", Kind: "text"}},
	{ID: "ipsec.encryption", Category: "VPN and failover", Description: "IPsec encryption algorithm", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "encryption", Path: "/encryption", Label: "Encryption", Kind: "text"}},
	{ID: "ipsec.integrity", Category: "VPN and failover", Description: "IPsec integrity algorithm", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "integrity", Path: "/integrity", Label: "Integrity", Kind: "text"}},
	{ID: "ipsec.local_ts", Category: "VPN and failover", Description: "Local IPsec traffic selector", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "local_ts", Path: "/local_ts", Label: "Local traffic selector", Kind: "text"}},
	{ID: "ipsec.remote_ts", Category: "VPN and failover", Description: "Remote IPsec traffic selector", SourceID: "ipsec", RequiredCapability: "ipsec", Field: Field{ID: "remote_ts", Path: "/remote_ts", Label: "Remote traffic selector", Kind: "text"}},
...
func (s *Core) monitoringTemplates(w http.ResponseWriter, r *http.Request) {
	...
	s.rows(w, `SELECT row_to_json(x) FROM (
		...
		WHERE ($1 OR t.organization_id=$2) AND NOT t.archived
		ORDER BY t.name
	) x`, a.AllOrgs, org)
}
...
func (s *Core) monitoringBindings(w http.ResponseWriter, r *http.Request) {
	...
	s.rows(w, `SELECT row_to_json(x) FROM (
		...
		WHERE $1 OR b.organization_id=$2 ORDER BY b.created_at DESC
	) x`, a.AllOrgs, org)
}
