...
import { identifierEntries } from "../lib/identifiers";
...
export default function DeviceDetail({
  ...
  return (
    <div className="flex min-h-full flex-col bg-card">
      <section className={cn("flex flex-wrap items-start justify-between gap-6 border-b border-border border-l-[3px] px-6 py-5", device.status === "ONLINE" ? "border-l-ok-rail" : device.status === "OFFLINE" ? "border-l-down-rail" : "border-l-neutral2")}>
