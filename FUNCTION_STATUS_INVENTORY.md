...
| `Dashboard()` | `Dashboard.tsx:12` | Overview dashboard. Fetches summary from API, renders fleet health KPI cards, Recharts donut chart for cellular carrier distribution, and signal quality gauges. | ⚡ Implemented w/ Fallback | Real API with fallback data |
